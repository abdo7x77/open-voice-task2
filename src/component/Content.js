...
export default function Content(){
    ...
    return(
      ...
      <section className="home" id="home">
        <div className="image">
          <img src="image/home-img.svg" alt="Home" />
        </div>
        <div className="content">
          <h3>stay safe, stay healthy</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet corrupti dolorem consequatur! Rem autem ut, porro impedit veniam perspiciatis.</p>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="image">
            <img src="image/about-img.svg" alt="About" />
          </div>
          <div className="content">
      ...
      <section className="doctors" id="doctors">
        <div className="box-container">
          <div className="box">
            <img src="image/doc-1.jpg" alt="Doctor 1" />
            <h3>rehab mostafa</h3>
          ...
          <div className="box">
            <img src="image/doc-2.jpg" alt="Doctor 2" />
            <h3>ali esmail</h3>
            <span>expert doctor</span>
            <div className="share">
              <a href="#" className="fab fa-facebook-f"></a>
          ...
          <div className="box">
            <img src="image/doc-4.jpg" alt="Doctor 4" />
          ...
          <div className="box">
            <img src="image/doc-5.jpg" alt="Doctor 5" />
            <h3>hossam ali</h3>
            <span>expert doctor</span>
            <div className="share">
              <a href="#" className="fab fa-facebook-f"></a>
          ...
          <div className="box">
            <img src="image/doc-3.jpg" alt="Doctor 3" />
            <h3>osama saad</h3>
            <span>expert doctor</span>
            <div className="share">
              <a href="#" className="fab fa-facebook-f"></a>
      ...
      <section className="book" id="book">
        ...
        <div className="row">
          <div className="image">
            <img src="image/book-img.svg" alt="Book" />
          </div>
          <form>
      ...
      <section className="review" id="review">
        ...
        <div className="box-container">
          <div className="box">
            <img src="image/pic-1.png" alt="Client 1" />
            <h3>john deo</h3>
            <span>satisfied client</span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit, fugiat!</p>
            <div className="stars">
          ...
          <div className="box">
            <img src="image/pic-2.png" alt="Client 2" />
            <h3>john deo</h3>
            <span>satisfied client</span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit, fugiat!</p>
            <div className="stars">
          ...
          <div className="box">
            <img src="image/pic-3.png" alt="Client 3" />
            <h3>john deo</h3>
            <span>satisfied client</span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit, fugiat!</p>
            <div className="stars">
